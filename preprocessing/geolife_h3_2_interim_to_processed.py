"""
Geolife Dataset Preprocessing (H3 Version) - Script 2: Interim to Processed
...
Input: data/geolife_h3r{resolution}/interim/
Output: data/geolife_h3r{resolution}/processed/
"""
...
def process_intermediate_to_final(config):
    ...
    print("=" * 80)
    print(f"GEOLIFE PREPROCESSING (H3) - Script 2: Interim to Processed")
    print("=" * 80)
...
def main():
    parser = argparse.ArgumentParser(
        description="Geolife preprocessing (H3 Version) - Script 2: Intermediate to Processed"
    )
    parser.add_argument(
        "--config",
        type=str,
