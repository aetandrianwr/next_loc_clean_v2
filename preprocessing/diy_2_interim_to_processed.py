...
Input: data/diy_eps{epsilon}/interim/
Output: data/diy_eps{epsilon}/processed/
"""
...
def process_for_previous_day(sp, split_ratios, max_duration, previous_day, epsilon, dataset_name, output_base_path, min_length=3):
...
def main():
    parser = argparse.ArgumentParser(
        description="DIY Dataset Preprocessing - Script 2: Interim to Processed"
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    print("=" * 80)
    print("DIY PREPROCESSING - Script 2: Interim to Processed")
    print("=" * 80)
    ...
    for previous_day in previous_day_list:
        metadata = process_for_previous_day(
            ...
            epsilon, dataset_name, output_base_path, min_length
        )
