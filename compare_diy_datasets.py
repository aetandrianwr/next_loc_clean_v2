...
def main():
    ...
    file_pairs = [
        ("train", 
         ...
         "/data/experiment_new_lose_2/poi_test_2/data/diy_skip_first_part/diy_skip_first_part_transformer_7_train.pk"),
        ("validation",
         "/data/next_loc_clean_v2/data/diy_eps50/processed/diy_eps50_prev7_validation.pk",
         "/data/experiment_new_lose_2/poi_test_2/data/diy_skip_first_part/diy_skip_first_part_transformer_7_validation.pk"),
        ("test",
         "/data/next_loc_clean_v2/data/diy_eps50/processed/diy_eps50_prev7_test.pk",
         "/data/experiment_new_lose_2/poi_test_2/data/diy_skip_first_part/diy_skip_first_part_transformer_7_test.pk"),
    ]
