...
This observation is fundamental to the Pointer Network V45 design - the pointer mechanism allows the model to "copy" locations from the user's history, which is often the correct strategy.
