...
The Pointer Generator Transformer is a **Position-Aware Pointer Network** that combines:
...
| Feature | Standard Transformer | Pointer Generator Transformer |
|---------|---------------------|---------------------|
...
| Feature | Standard Pointer Net | Pointer Generator Transformer |
|---------|---------------------|---------------------|
...
| Feature | DeepMove | Pointer Generator Transformer |
|---------|----------|---------------------|
