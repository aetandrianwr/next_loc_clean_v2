#!/bin/bash
#
# Sequence Length Days Experiment V2 - Master Run Script
#
# This script runs the complete sequence length experiment including:
# 1. Evaluation on DIY and GeoLife datasets
# 2. Generation of visualizations and analysis (V2 publication style)
#
# Usage:
#   ./run_experiment.sh
#
...
echo "=========================================="
echo "SEQUENCE LENGTH EXPERIMENT V2"
...
mkdir -p scripts/experiment_sequence_len_days_v2/results

# Run evaluation experiments
echo ""
echo "[2/4] Running evaluation experiments..."
echo "----------------------------------------"
python scripts/experiment_sequence_len_days_v2/evaluate_sequence_length.py --dataset all

# Generate visualizations
echo ""
echo "[3/4] Generating visualizations and analysis..."
echo "----------------------------------------"
python scripts/experiment_sequence_len_days_v2/visualize_results.py

# Display summary
echo ""
echo "[4/4] Experiment Complete!"
echo "=========================================="
echo "Results saved to: scripts/experiment_sequence_len_days_v2/results/"
echo ""
echo "Output Files:"
ls -1 scripts/experiment_sequence_len_days_v2/results/
echo ""
