"""
Ablation Model for Pointer Generator Transformer.

This module implements a modified PointerGeneratorTransformer with configurable
...
class PointerGeneratorTransformerAblation(nn.Module):
    """
    Pointer Generator Transformer with Ablation Support.
