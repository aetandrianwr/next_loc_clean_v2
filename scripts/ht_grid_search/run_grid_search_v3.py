...
Usage:
    ...
    python scripts/ht_grid_search/run_grid_search_v3.py --max_epochs 50 --model pgt  # Only PGT
    ...
    A100
    python scripts/ht_grid_search/run_grid_search_v3.py --max_epochs 50 --num_workers 32 --model pgt --delay 1
...
def main():
    ...
    parser.add_argument("--model", type=str, default="all", choices=["all", "pgt", "MHSA", "LSTM"],
                        help="Model to tune: "pgt", 'MHSA', 'LSTM', or 'all' (default: all)")
