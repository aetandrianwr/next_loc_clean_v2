...
Usage:
    python scripts/ht_grid_search/run_grid_search_v2.py --max_epochs 2  # Test run
    python scripts/ht_grid_search/run_grid_search_v2.py --max_epochs 50 # Full run
    python scripts/ht_grid_search/run_grid_search_v2.py --max_epochs 50 --model pointer_v45  # Only PointerV45
    python scripts/ht_grid_search/run_grid_search_v2.py --max_epochs 50 --model MHSA  # Only MHSA
    python scripts/ht_grid_search/run_grid_search_v2.py --max_epochs 50 --model LSTM  # Only LSTM
"""
