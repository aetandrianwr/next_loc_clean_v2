...
def init_experiment_dir(config, dataset_name):
    ...
    Format: experiments/{dataset_name}_LSTM_{yyyyMMdd_hhmmss}/
    """
    ...
    experiment_name = f"{dataset_name}_LSTM_{timestamp}"
...
def main():
    parser = argparse.ArgumentParser(description="Train LSTM model for next location prediction")
    ...
    log_file.write(f"Training LSTM model\n")
