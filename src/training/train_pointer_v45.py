"""
Training script for Pointer Network V45 (Proposed Model).

This script handles training and evaluation of the PointerNetworkV45 model
...
def init_experiment_dir(config: Dict, dataset_name: str, model_name: str = "pointer_v45") -> str:
    """
...
def main():
    parser = argparse.ArgumentParser(description="Train Pointer V45 model for next location prediction")
    ...
    experiment_dir = init_experiment_dir(config, dataset_name, "pointer_v45")
    print(f"Experiment directory: {experiment_dir}")
    
    print("=" * 60)
    print("POINTER V45 - Clean & Lean")
    print("=" * 60)
