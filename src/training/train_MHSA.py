"""
Training script for Multi-Head Self-Attention (MHSA) Model.
...
def init_experiment_dir(config, dataset_name):
    ...
    Format: experiments/{dataset_name}_MHSA_{yyyyMMdd_hhmmss}/
    """
    ...
    experiment_name = f"{dataset_name}_MHSA_{timestamp}"
...
def main():
    parser = argparse.ArgumentParser(description="Train MHSA model for next location prediction")
    ...
    log_file.write(f"Training MHSA model\n")
